...
{
       0,    52,    52,    58,    59,    64,    77,    78,    83,    89,
      97,    98,   103,   108,   115,   121,   126
};
#endif
...
{
     -10,    -4,     3,   -11,   -10,    -2,   -11,   -11,    -1,    -7,
       0,     1,    -7,     6,    -3,   -11,   -11,   -11,   -11,   -11,
       5,     4,     7,   -11,    -3,    10,   -11,     7
};
...
{
       3,     0,     0,     2,     3,     0,     1,     4,     0,     6,
       0,     0,     6,     0,    10,     5,     7,     8,    15,    13,
       0,    11,    14,     9,    10,     0,    12,    16
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -11,   -11,    11,   -11,     2,   -11,   -11,    -8,   -11,    -6
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     4,    11,    12,    13,    20,    21,    22
};
...
{
      18,     1,     5,     6,    10,     8,    14,     9,    24,    19,
      15,    17,    23,    18,    16,     7,    26,    25,     0,    27
};

static const yytype_int8 yycheck[] =
{
       3,    11,     6,     0,    11,     7,     6,     8,     4,    12,
       9,     5,     7,     3,    12,     4,    24,    10,    -1,    25
};
...
static const yytype_uint8 yystos[] =
{
      ...
      11,    17,    18,    19,     6,     9,    17,     5,     3,    12,
      20,    21,    22,     7,     4,    10,    20,    22
};
...
#line 60 "parser.y" /* yacc.c:1646  */
    {
         (yyval.str) = (char*) malloc( strlen((yyvsp[-1].str)) + strlen((yyvsp[0].str)) + 100 );
...
#line 65 "parser.y" /* yacc.c:1646  */
    {
          ...
          (yyval.str) = (char*) malloc( strlen((yyvsp[-5].str)) + strlen((yyvsp[-1].str)) + 200 );
          char* preamble = (char*) malloc( strlen((yyvsp[-5].str)) + 100 );
          char* middle = (char*) malloc( strlen((yyvsp[-1].str)) + 100 );
          char* postamble = (char*) malloc( 100 );
          sprintf( preamble, "\t.text\n\t.globl\t%s\n\t.type\t%s, @function\n%s:\n\tpushq\t%%rbp\n\tmovq\t%%rsp, %%rbp\n", (yyvsp[-5].str), (yyvsp[-5].str), (yyvsp[-5].str) );
          sprintf( middle, "%s", (yyvsp[-1].str) );
...
#line 84 "parser.y" /* yacc.c:1646  */
    {
          ...
          (yyval.str) = (char*) malloc( strlen((yyvsp[-1].str)) + 100 );
...
#line 90 "parser.y" /* yacc.c:1646  */
    {
          ...
          (yyval.str) = (char*) malloc( strlen((yyvsp[-3].str)) + strlen((yyvsp[-1].str)) + 100 );
...
#line 99 "parser.y" /* yacc.c:1646  */
    {
         (yyval.str) = (char*) malloc( strlen((yyvsp[0].str)) + 100 );
         sprintf( (yyval.str), "%s\n", (yyvsp[0].str) );
       }
...
#line 104 "parser.y" /* yacc.c:1646  */
    {
         (yyval.str) = (char*) malloc( strlen((yyvsp[-2].str)) + strlen((yyvsp[0].str)) + 100 );
...
#line 109 "parser.y" /* yacc.c:1646  */
    {
         (yyval.str) = (char*) malloc( strlen((yyvsp[0].str)) + 100 );
         int stringind = addString ( (yyvsp[0].str) );
...
#line 122 "parser.y" /* yacc.c:1646  */
    {
         (yyval.str) = (char*) malloc( sizeof((yyvsp[0].ival)) * 5 + 100 );
         sprintf( (yyval.str), "\n\tmovl\t$%d, %%eax", (yyvsp[0].ival) );
       }
